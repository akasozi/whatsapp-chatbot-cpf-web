...
const ApplicationDetails = () => {
  ...
  const isLoading = useSelector((state) => state.applications.loadingStatus.fetchApplicationDetails === 'pending');
  const isUpdating = useSelector((state) => state.applications.loadingStatus.updateStatus === 'pending');
  const isAddingNote = useSelector((state) => state.applications.loadingStatus.addNote === 'pending');
      ...
      <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold">{application.form_name} Application</h1>
          </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <div className="mt-1 text-sm text-gray-900">
                      {new Intl.NumberFormat('en-UG', {
                        style: 'currency',
                        currency: 'UGX'
                      }).format(application.form_data.employment_details.monthly_income)}
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-500">Initial Contribution</label>
                    <div className="mt-1 text-sm text-gray-900">
                      {new Intl.NumberFormat('en-UG', {
                        style: 'currency',
                        currency: 'UGX'
                      }).format(application.form_data.contribution_details.initial_contribution)}
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="mt-1 text-sm text-gray-900">
                      {new Intl.NumberFormat('en-UG', {
                        style: 'currency',
                        currency: 'UGX'
                      }).format(application.form_data.contribution_details.monthly_contribution)}
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-500">Payment Method</label>
                    <div className="mt-1 text-sm text-gray-900">{application.form_data.contribution_details.payment_method.replace(/_/g, ' ')}</div>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-500">Start Date</label>
                    <div className="mt-1 text-sm text-gray-900">{application.form_data.contribution_details.start_date}</div>
                  </div>
                </div>
              </section>
            </div>
            ...
            <section className="mt-8">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-500">Risk Tolerance</label>
                    <div className="mt-1 text-sm text-gray-900">{application.form_data.investment_preferences.risk_tolerance}</div>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-500">Preferred Portfolio</label>
                    <div className="mt-1 text-sm text-gray-900">{application.form_data.investment_preferences.preferred_portfolio}</div>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-500">Investment Horizon</label>
                    <div className="mt-1 text-sm text-gray-900">{application.form_data.investment_preferences.investment_horizon.replace(/_/g, ' ')}</div>
                  </div>
                </div>
              </div>
            </section>
