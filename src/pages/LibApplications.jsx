...
import { fetchLibApplications, updateFilters, selectFilteredLibApplications } from '../redux/slices/libApplicationsSlice';
import { Link } from 'react-router-dom';
import DashboardLayout from '../layouts/DashboardLayout';

const LibApplications = () => {
  const dispatch = useDispatch();
  const applications = useSelector(selectFilteredLibApplications);
  const loadingStatus = useSelector((state) => state.libApplications.loadingStatus.fetchLibApplications);
  ...
  return (
    <DashboardLayout>
      <div className="mb-6">
        <h1 className="text-2xl font-bold">LIB Flex Maisha Applications</h1>
        <p className="text-gray-600">
          View and manage LIB Flex Maisha life insurance applications submitted through WhatsApp
        </p>
      </div>
                ...
                <tr key={application.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-xs text-gray-500">
                      {application.form_data.policy_details.policy_type}
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
...
export default LibApplications;